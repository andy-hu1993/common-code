...
public class ImageUtils {
    ...
    public static void main(String[] args) {
        ...
        // 5-给图片添加文字水印：
        // 方法一：
        ImageUtils.pressText("我是水印文字", "d:/abc.jpg", "d:/abc_pressText.jpg", "宋体", Font.BOLD, Color.white, 80, 0, 0,
            0.5f);//测试OK
        // 方法二：
        ImageUtils.pressText2("我也是水印文字", "d:/abc.jpg", "d:/abc_pressText2.jpg", "黑体", 36, Color.white, 80, 0, 0,
            0.5f);//测试OK
     ...
     * @throws
     * @Title: cut
     * @Description: 切割图像- 按指定起点坐标和宽高切割
     * @date 2017年5月12日 下午4:57:13
     */
     ...
     * @param @param descDir
     * @param @param rows
     * @param @param cols    设定文件
     * @return void    返回类型
     * @throws
     * @Title: cut2
     * @Description: 指定切片的行数和列数
     * @date 2017年5月12日 下午4:57:38
     */
     ...
     * @param @param destHeight    设定文件
     * @return void    返回类型
     * @throws
     * @Title: cut3
     * @Description: 指定切片的宽度和高度
     * @date 2017年5月12日 下午4:58:02
     */
     ...
     * @param @param destImageFile    设定文件
     * @return void    返回类型
     * @throws
     * @Title: convert
     * @Description: 图像类型转换
     * @date 2017年5月12日 下午4:58:21
     */
    ...
    /**
     * @param @param pressText
     * @param @param srcImageFile
     * @param @param destImageFile
     ...
     * @param @param x
     * @param @param y
     * @param @param alpha    设定文件
     * @return void    返回类型
     * @throws
     * @Title: pressText
     * @Description: 给图片添加文字水印
     * @date 2017年5月12日 下午4:58:45
     */
     ...
     * @date 2017年5月12日 下午4:59:28
     */
    public final static void pressImage(String pressImg, String srcImageFile, String destImageFile, int x, int y, float
        alpha) {
        try {
            File img = new File(srcImageFile);
            Image src = ImageIO.read(img);
